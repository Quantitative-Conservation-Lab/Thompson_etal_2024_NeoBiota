...
##### grow_4rem_p1 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p1_s1'
...
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p1_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_4rem_p2 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p2_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p2_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_4rem_p3 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p3_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_4rem_p3_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_8rem_p1 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p1_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p1_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_8rem_p2 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p2_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p2_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_8rem_p3 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p3_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_8rem_p3_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_8rem_p1 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p1_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p1_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_16rem_p2 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p2_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p2_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
##### grow_16rem_p3 #####
#-----------------------------------------------------------------------------#
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p3_s1'
file_name = paste(path, 'N.csv',sep = '/')
...
path <- 'D:\\Chapter2\\results\\grow\\grow_16rem_p3_s2'
file_name = paste(path, 'N.csv',sep = '/')
...
#------------------- final N total -----------------------------------#
grow_Nfin <- rbind(N_grow_4_p1_Nfin,N_grow_4_p2_Nfin,N_grow_4_p3_Nfin,
...
#------------------- N vs time -----------------------------------#
grow_Nvtime <- rbind(grow_4_p1_Nvtime,grow_4_p2_Nvtime,grow_4_p3_Nvtime,
...
#------------------- distance traveled  -----------------------------------#
grow_Dtrav <- rbind(Dtrav_grow_4_p1_sum,Dtrav_grow_4_p2_sum,Dtrav_grow_4_p3_sum,
