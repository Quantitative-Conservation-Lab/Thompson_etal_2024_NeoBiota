...
#### Max-max plots ####
abund_seg1 <- abund_seg %>% filter(param == 9 & p == '1', rem == '1', sim == 7)
abund_seg4 <- abund_seg %>% filter(param == 9 & p == '1', rem == '4', sim == 6)
abund_seg8 <- abund_seg %>% filter(param == 9 & p == '1', rem == '8', sim == 20)
abund_seg16 <- abund_seg %>% filter(param == 9 & p == '1', rem == '16', sim == 3)

abund_max <- rbind(abund_seg1, abund_seg4, abund_seg8, abund_seg16)

down_seg1 <- down_seg %>% filter(param == 9 & p == '1', rem == '1', sim == 22)
down_seg4 <- down_seg %>% filter(param == 9 & p == '1', rem == '4', sim == 8)
down_seg8 <- down_seg %>% filter(param == 9 & p == '1', rem == '8', sim == 9)
down_seg16 <- down_seg %>% filter(param == 9 & p == '1', rem == '16', sim == 15)

down_max <- rbind(down_seg1, down_seg4, down_seg8, down_seg16)

edge_seg1 <- edge_seg %>% filter(param == 9 & p == '1', rem == '1', sim == 3)
edge_seg4 <- edge_seg %>% filter(param == 9 & p == '1', rem == '4', sim == 7)
edge_seg8 <- edge_seg %>% filter(param == 9 & p == '1', rem == '8', sim == 8)
edge_seg16 <- edge_seg %>% filter(param == 9 & p == '1', rem == '16', sim == 11)

edge_max <- rbind(edge_seg1, edge_seg4, edge_seg8, edge_seg16)

grow_seg1 <- grow_seg %>% filter(param == 9 & p == '1', rem == '1', sim == 11)
grow_seg4 <- grow_seg %>% filter(param == 9 & p == '1', rem == '4', sim == 25)
grow_seg8 <- grow_seg %>% filter(param == 9 & p == '1', rem == '8', sim == 23)
grow_seg16 <- grow_seg %>% filter(param == 9 & p == '1', rem == '16', sim == 23)

grow_max <- rbind(grow_seg1, grow_seg4, grow_seg8, grow_seg16)

random_seg1 <- random_seg %>% filter(param == 9 & p == '1', rem == '1', sim == 3)
random_seg4 <- random_seg %>% filter(param == 9 & p == '1', rem == '4', sim == 7)
random_seg8 <- random_seg %>% filter(param == 9 & p == '1', rem == '8', sim == 19)
random_seg16 <- random_seg %>% filter(param == 9 & p == '1', rem == '16', sim == 9)

random_max <- rbind(random_seg1, random_seg4, random_seg8, random_seg16)

nocontrol_segmax <- nocontrol_seg %>% filter(param == 9, sim == 40)



all_segmax <- rbind(abund_max,down_max,edge_max,
                    grow_max,random_max, nocontrol_segmax)


path <- 'E:\\Chapter2\\results'
file_name = paste(path, 'all_segmax.csv',sep = '/')
fwrite(all_segmax,file_name)
