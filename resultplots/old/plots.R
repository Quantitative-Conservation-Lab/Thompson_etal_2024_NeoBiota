...
all_Ntotal_rem1$location[all_Ntotal_rem1$location == 'edges'] <- 'edge1'
...
all_Ntotal_rem4$location[all_Ntotal_rem4$location == 'edges'] <- 'edge4'
...
all_Ntotal_rem8$location[all_Ntotal_rem8$location == 'edges'] <- 'edge8'
...
all_Ntotal_rem16$location[all_Ntotal_rem16$location == 'edges'] <- 'edge16'
...
all_Ninvade_rem1$location[all_Ninvade_rem1$location == 'edges'] <- 'edge1'
...
all_Ninvade_rem4$location[all_Ninvade_rem4$location == 'edges'] <- 'edge4'
...
all_Ninvade_rem8$location[all_Ninvade_rem8$location == 'edges'] <- 'edge8'
...
all_Ninvade_rem16$location[all_Ninvade_rem16$location == 'edges'] <- 'edge16'
...
all_Dcol_rem1$location[all_Dcol_rem1$location == 'edges'] <- 'edge1'
...
all_Dcol_rem4$location[all_Dcol_rem4$location == 'edges'] <- 'edge4'
...
all_Dcol_rem8$location[all_Dcol_rem8$location == 'edges'] <- 'edge8'
...
all_Dcol_rem16$location[all_Dcol_rem16$location == 'edges'] <- 'edge16'
